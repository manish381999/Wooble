...
import com.wooble.wooble.databinding.ActivityEditBlogsBinding;
...
public class Edit_BlogActivity extends AppCompatActivity {
    ...
    String file_id, title, content, created_date, email_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityEditBlogsBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

       result = getIntent().getStringExtra("id");
...
//        binding.tvFullName.setText(email_id);
        ...
        binding.blogEditor.setHtml(content);
        ...
        binding.actionTxtColor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new ColorPickerPopup.Builder(Edit_BlogActivity.this).initialColor(Color.BLACK)
        ...
        binding.actionBgColor.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                new ColorPickerPopup.Builder(Edit_BlogActivity.this).initialColor(Color.WHITE)
                        .enableBrightness(true)
                        .enableAlpha(true)
                        .okTitle("Choose")
                        .cancelTitle("Cancel")
        ...
        pickImage = registerForActivityResult(new ActivityResultContracts.GetContent(), new ActivityResultCallback<Uri>() {
            ...
            public void onActivityResult(Uri result) {
                Intent intent = new Intent(Edit_BlogActivity.this, Gallery_Image_CropperActivity.class);
            ...
            public void onClick(View v) {
                try {
                    if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA)
                        ...
                        ActivityCompat.requestPermissions(Edit_BlogActivity.this, new String[]{Manifest.permission.CAMERA}, 100);
                    }
                    showImageOptions();
    ...
    void PublishBlog() {
        ...
        call.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, retrofit2.Response<ResponseModel> response) {
                ...
                Toast.makeText(getApplicationContext(), output, Toast.LENGTH_SHORT).show();
                //blogEditor.insertAudio(audioURL);
                Intent intent = new Intent(Edit_BlogActivity.this, BlogFragment.class);
                startActivity(intent);
                finish();
                //Intent intent = new Intent().setClassName(Edit_BlogActivity.this,"com.wooble.wooble.ui.Blogs.BlogFragment.class");
                //Edit_BlogActivity.this.startActivity(intent);
            }
